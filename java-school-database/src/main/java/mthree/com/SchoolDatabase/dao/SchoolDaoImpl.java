    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Course> csCourses() {
        ...
        // YOUR CODE STARTS HERE
         ...
         String sql = "SELECT courseCode, courseDesc FROM course c INNER JOIN teacher t ON t.tid = c.teacherId WHERE dept = 'Computer Science' ";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT courseCode, courseDesc, COUNT(student_id) AS numStudents FROM course JOIN course_student ON cid = course_id GROUP BY courseCode";
